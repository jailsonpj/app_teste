...
var Tab2Page = /** @class */ (function () {
    function Tab2Page(camera, sn, http, loadingCrtl, toast) {
        this.camera = camera;
        this.sn = sn;
        this.http = http;
    ...
    Tab2Page.prototype.baterFoto = function () {
        var _this = this;
        this.camera.getPicture(this.options).then(function (imageData) {
            console.log(imageData);
            _this.imagem = 'data:image/jpeg;base64,' + imageData;
            _this.img_api = imageData;
        }, function (err) {
            alert('Ops!\nHouve um erro');
            console.log(err);
        });
    };
    Tab2Page.prototype.predictImg = function () {
        var _this = this;
        var data_img = {
            "image": this.img_api,
        };
        alert("TE");
        alert(this.img_api);
        this.http.post(this.API_URL, data_img, {}).then(function (data) {
...
var Tab3Page = /** @class */ (function () {
    ...
    Tab3Page.prototype.abrirGaleria = function () {
        var _this = this;
        this.camera.getPicture(this.options).then(function (imageData) {
...
var TabsPage = /** @class */ (function () {
    function TabsPage(camera, sn, nav, http) {
        this.camera = camera;
        this.sn = sn;
        this.nav = nav;
        this.http = http;
    ...
    TabsPage.prototype.ngOnInit = function () {
        ...
        console.log("TTTOO");
        //alert('ENTROU');
        this.http.get(this.API_URL, {}, {}).then(function (data) {
    ...
    TabsPage.prototype.pushPage2 = function () {
        this.nav.navigateForward("/tabs/tab2");
    };
    TabsPage.prototype.pushPage3 = function () {
